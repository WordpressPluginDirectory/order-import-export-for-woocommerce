...
class Wt_Import_Export_For_Woo_Basic_Order_Bulk_Export {
    ...
    public static $is_eh_stripe_active;
    public static $is_wc_stripe_active;
	...
	if (self::$wpo_wcpdf):
        ...
        if (self::$is_wc_paypal_active):
         ...
         if (self::$is_eh_stripe_active):
            $stripe_fee = get_post_meta($order_data['order_id'], 'eh_stripe_fee', true);
